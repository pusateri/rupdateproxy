...
pub fn join_multicast(multicast_addr: &SocketAddr, if_addr: &SocketAddr, if_index: u32) -> 
    ...
    let socket = match mc_addr {
        IpAddr::V4(ref mc_v4addr) => {
            ...
            match if_addr.ip() {
                IpAddr::V4(ref addr4) => {
                    socket.join_multicast_v4(mc_v4addr, addr4).expect("join_multicast_v4");
        ...
        IpAddr::V6(ref mdns_v6) => {
            ...
            socket.join_multicast_v6(mdns_v6, if_index).expect("join_multicast_v6");
            socket
        }
    };
